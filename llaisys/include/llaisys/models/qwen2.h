...
__C {
    ...
    __export void llaisysQwen2ModelForward(struct LlaisysQwen2Model * model, int64_t * token_ids, size_t ntoken, float * logits_out);

    __export void llaisysQwen2ModelResetKV(struct LlaisysQwen2Model * model);
}
